...
using Serialization
serialize("./models/1_community_oscillation/24-07-2025-untuned.jls", result_neuralode2.u)

my_data_from_serialized = deserialize("./models/1_community_oscillation/24-07-2025-untuned.jls")